...
def run_rhc(hcp, ef, iterations=200):
...
def run_sa(hcp, ef, iterations=200):
...
def run_ga(gap, ef, iterations=300):
...
def run_mimic(pop, ef, iterations=100):
...
if __name__ == '__main__':
    ...
    # for trial in range(trial_number):
    output_file_name = '{}/output_countones_N130_runs{}.csv'.format(output_path,trial_number)
    run_algorithm_test(ranges=ranges,
